...
const categories=[
 ["Walk Behind Roller","5 products","rw750d-2.webp"],["Construction Machines","7+ products","forward-plate-1.jpg"],["Rental Service","3 products","cc125-2.jpg"],["Roller Rental Services","3 products","rw750d-1.webp"],["Compactors Rental Service","2 products","compactor-3t-1.jpg"],["Steel Bar Bending Machine","1 product","steel-bending-1.jpeg"],["Vibration Roller","1 product","rammer-1.png"],["Bar Bending Machine","1 product","steel-bending-2.webp"],["Mobile Light Tower","2 products",""],["New Items","1 product","soil-roller-1.jpg"],["Dynapac CC245 Roller Rental","1 product","cc245.jpg"]
];
const products=[
...
// Images are stored at the repository root, so GitHub Pages uses stable relative paths.
...
function aiProductAnswer(q){
  ...
  const aliases=[
    ['rw750d',['rw750d','rw 750','walk behind','walk behind roller','walk behind vibrating roller','redline','walk-behind','700 kg','600 mm','9 hp','kholer','kohler','3t','3 ton capacity']],
    ['rw750d-sale',['600000','650000','6,00,000','6,50,000','6 lakh','6.5 lakh','sale price','walk behind roller sale']],
...
(() => {
  ...
  if (track && track.children.length) {
    ...
    // Target speed: 7px/frame at ~60fps = ~420 CSS px/sec (about half of the earlier speed, slightly higher).
    // Use elapsed-time movement so Firefox/Edge keep the same real-world speed
    // even when their animation frame rate differs.
    const GALLERY_SPEED_PX_PER_SEC = 420;
...
window.PR_GALLERY_SPEED = 420; // CSS pixels per second; frame-rate independent
